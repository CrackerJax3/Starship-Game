...
const Images = {
  ship: img('../public/StarshipSprites/fullstack.png'),
  shipTop: img('../public/StarshipSprites/starship.png'),
  shipBottom: img('../public/StarshipSprites/booster.png'),
  starlink: img('../public/images/Starlink.png'),
  launchpad: img('../public/images/Launchpad.png'),
  tower: img('../public/StarshipSprites/Tower.png'),
  chopsticks: img('../public/StarshipSprites/Chopsticks.png'),
  ground: img('../public/images/Ground.png'),
  earth: img('../public/images/Earth.png'),
  arrow_white: img('../public/images/Arrow White.png'),
};
